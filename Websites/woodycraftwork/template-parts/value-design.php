<?php
/**
 * Value split — Design process (reversed, tinted; media left, text right).
 * ACF tab: Design Process (group_landing_page)
 */
if (!defined('ABSPATH')) { exit; }

$eyebrow   = get_field('design_eyebrow');
$headline  = get_field('design_headline');
$copy      = get_field('design_copy');
$list      = get_field('design_list');
$image     = get_field('design_image');
$tag       = get_field('design_tag');
$primary   = get_field('design_primary_cta');
$secondary = get_field('design_secondary_cta');

if (!$headline) { return; }
?>

<section class="value rev tint">
    <div class="container">
