<?php
/**
 * Value split — Homes & businesses (text left, media right).
 * ACF tab: Homes & Businesses (group_landing_page)
 */
if (!defined('ABSPATH')) { exit; }

$eyebrow   = get_field('scope_eyebrow');
$headline  = get_field('scope_headline');
$copy      = get_field('scope_copy');
$list      = get_field('scope_list');
$image     = get_field('scope_image');
$tag       = get_field('scope_tag');
$primary   = get_field('scope_primary_cta');
$secondary = get_field('scope_secondary_cta');
